                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <div class="gutters">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <h6 class="mb-2 text-primary">Add Product</h6>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="fullName">Name Product</label>
                                        <input type="text" class="form-control" id="fullName" name="name_product" placeholder="...">
                                    </div>
                                    <div class="form-group">
                                        <label for="fullName">Price</label>
                                        <input type="text" class="form-control" id="fullName" name="price" placeholder="...">
                                    </div>
                                </div>
                            ...
                            <div class="row gutters">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="text-right">
                                        ...
                                        <button type="submit" id="submit" name="add_product" class="btn btn-primary">Update</button>
                                    </div>
                                </div>
                            </div>
                        </form>
