...
<head>
    ...
    <title>Frutin - Organic and Healthy Food php Template - Team Details</title>
...
<body>
    ...
    <section class="space">
        <div class="container">
            <div class="row mb-5">
                <div class="col-xl-6">
                    <div class="about-card-img"><img src="assets/img/team/team_details.jpg" alt="team image"></div>
                </div>
                <div class="col-xl-6">
                    <div class="about-card">
                        <h2 class="about-card_title">Alhando Robert</h2>
                        <p class="about-card_desig">Senior Farmers</p>
                        <div class="th-social"><a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a> <a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a> <a target="_blank" href="https://instagram.com/"><i class="fab fa-instagram"></i></a> <a target="_blank" href="https://linkedin.com/"><i class="fab fa-linkedin-in"></i></a> <a target="_blank" href="https://pinterest.com/"><i class="fab fa-pinterest-p"></i></a></div>
                        ...
                        <div class="team-info">
                            <ul>
                                ...
                                <li><b>Email:</b> <a href="mailto:alhandorobert@gmail.com">alhandorobert@gmail.com</a></li>
                                <li><b>Website:</b> <a href="http://example.com/example">http://example.com/example</a></li>
            ...
            <p class="mb-4">Specific information about an individual named "Alhando Robert Farmer" in my database. It's possible that this person is not widely known or may not be part of public records up until my last knowledge update in September 2021. If "Alhando Robert Farmer" is a private individual or a figure that gained prominence after September 2021, I won't have any information on them. If you have additional context or details about this person, feel free to share them, and I'll do my best to assist you based on the information available up to September 2021.</p>
            <p class="mb-40">Diversity is a cornerstone of our farming philosophy. We carefully select a wide range of crops, ensuring a varied and balanced ecosystem. This not only helps to naturally deter pests and diseases but also promotes soil health by varying the nutrient demands of different plants. Crop rotation further enhances the soil's fertility by preventing the depletion of specific nutrients. This strategic planning ensures that our fields remain productive and vibrant year after year.</p>
            <div class="row mt-5">
                <div class="col-xl-6 mb-40 mb-xl-0">
                    <div class="me-xl-4">
                        <h4 class="fw-semibold mb-20 mt-n2">Personal Skills</h4>
                        <p class="mb-30">With our highly skilled farming technicians, you can trust that your farm is in expert hands. Contact us today to schedule a service with Frutin.</p>
                        <div class="skill-feature">
                            <h5 class="skill-feature_title">Protection</h5>
                            <div class="progress">
                        ...
                        <div class="skill-feature">
                            <h5 class="skill-feature_title">Driving</h5>
                            <div class="progress">
                        ...
                        <div class="skill-feature">
                            <h5 class="skill-feature_title">Road Tests</h5>
                            <div class="progress">
                                <div class="progress-bar" style="width: 95%;">
                                    <div class="progress-value">95%</div>
                                </div>
...
<!-- Mirrored from themeholy.com/php/frutin/demo/team-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Nov 2023 13:49:10 GMT -->
