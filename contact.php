...
<!-- Mirrored from themeholy.com/php/frutin/demo/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Nov 2023 13:49:29 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Frutin - Organic and Healthy Food php Template - Contact Us</title>
...
<body>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="contact-feature">
                        ...
                        <div class="media-body">
                            ...
                            <p class="box-text"><a href="tel:+16326543654">+(163)-2654-3654</a> <a href="tel:+16326545566">+(163)-2654-5566</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="contact-feature">
                        ...
                        <div class="media-body">
                            ...
                            <p class="box-text"><a href="mailto:help24/7@frutin.com">help24/7@frutin.com</a> <a href="mailto:info@frutin.com">info@frutin.com</a></p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6">
    ...
    <div class="space-bottom">
        <div class="container">
            <form action="https://themeholy.com/php/frutin/demo/mail.php" method="POST" class="contact-form input-smoke ajax-contact">
                ...
                <div class="row">
                    ...
                    <div class="form-btn col-12"><button class="th-btn btn-fw">Send Message<i class="fas fa-chevrons-right ms-2"></i></button></div>
                </div>
