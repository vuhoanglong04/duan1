...
<head>
    ...
    <title>Frutin - Organic and Healthy Food php Template - Blog Details</title>
                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="th-blog blog-single">
                        ...
                        <div class="blog-content">
                            ...
                            <blockquote>
                                <p>Choose organic food, not only for a healthier you but for a happier planet too. It's a conscious choice that nourishes both body and Earth.</p><cite>Michel Clarck</cite>
                            </blockquote>
                            ...
                            <div class="row mt-15">
                                <div class="col-md-6 mb-4"><img class="w-100 rounded-20" src="assets/img/blog/blog_inner_1.jpg" alt="Blog Image"></div>
                                <div class="col-md-6 mb-4"><img class="w-100 rounded-20" src="assets/img/blog/blog_inner_2.jpg" alt="Blog Image"></div>
                            </div>
                            ...
                            <div class="share-links clearfix">
                                <div class="row justify-content-between">
                                    <div class="col-sm-auto"><span class="share-links-title">Tags:</span>
                                        <div class="tagcloud"><a href="blog.php">Agriculture</a> <a href="blog.php">Organic</a></div>
                                    </div>
                                    <div class="col-sm-auto text-xl-end"><span class="share-links-title">Share On:</span>
                        ...
                        <ul class="comment-list">
                            <li class="th-comment-item">
                                <div class="th-post-comment">
                                    ...
                                    <div class="comment-content"><span class="commented-on"><i class="far fa-calendar"></i>14 March, 2023</span>
                                        ...
                                        <div class="reply_and_edit"><a href="blog-details.php" class="reply-btn"><i class="fas fa-reply"></i>Reply</a></div>
                                    </div>
                                </div>
                                <ul class="children">
                                    <li class="th-comment-item">
                                        <div class="th-post-comment">
                                            ...
                                            <div class="comment-content"><span class="commented-on"><i class="far fa-calendar"></i>15 March, 2023</span>
                            ...
                            <li class="th-comment-item">
                                <div class="th-post-comment">
                                    ...
                                    <div class="comment-content"><span class="commented-on"><i class="far fa-calendar"></i>16 March, 2023</span>
