...
<body>
    ...
    if (isset($_POST['recover'])) {
        ...
        if($get_code != $_SESSION['code']['code']){
            $error_code = "Wrong code";
        }
        else{
                if($date > $_SESSION['code']['date']){
                    $error_code = "The code has expired. Please try another";
                }else{
                    header('Location: enterNewPass.php');
                }
        }
    }
    ?>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12">
                                <div class="authfy-heading">
                                    <h3 class="auth-title">Please enter the code that has been sent to your email.</h3>
                                </div>
                                <form name="forgetForm" class="forgetForm" method="POST">

                                    <div class="form-group">
                                        <input style="text-align: center;" type="text" class="form-control" minlength="6" maxlength="6" name="code" placeholder="_ _ _ _ _ _ ">
                                        <p style="color:red; text-align: left;"><?= $error_code ?></p>

                                    </div>
                                    <div class="form-group">
                                        <a href="forgotPass.php">Do not receive the code?</a>
                                    </div>
                                    <div class="form-group">
