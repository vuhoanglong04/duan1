...
<!-- Mirrored from themeholy.com/php/frutin/demo/service-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Nov 2023 13:49:03 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Frutin - Organic and Healthy Food php Template - Service Details</title>
                        ...
                        <div class="page-content">
                            ...
                            <div class="service-feature-wrap">
                                <div class="service-feature">
                                    <div class="box-icon"><img src="assets/img/icon/service_feature_1.svg" alt="Icon"></div>
                                    <div class="media-body">
                                        <h4 class="box-title">100% Organic</h4>
                                        <p class="box-text">Our products are certified by reputable organic you're often supporting</p>
                                    </div>
                                </div>
                                <div class="service-feature">
                                    <div class="box-icon"><img src="assets/img/icon/service_feature_2.svg" alt="Icon"></div>
                                    <div class="media-body">
                                        <h4 class="box-title">Fresh Products</h4>
                                        <p class="box-text">Our products are certified by reputable organic you're often supporting</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-40 gx-40">
                                <div class="col-md-6 mb-30"><img class="rounded-20 w-100" src="assets/img/service/service_inner_1.jpg" alt="service"></div>
                                <div class="col-md-6 mb-30">
                                    <h4 class="mt-n1">Project Management</h4>
                                    <p class="mb-4">Organic farming relies on natural methods like composting, crop rotation, and biological pest control to maintain soil health and manage pests. This means no synthetic chemicals are used in the cultivation process.</p>
                                    <p class="mb-0">In organic livestock farming, animals are treated with care and respect. They are provided with access to the outdoors, clean living conditions.</p>
                                </div>
                            </div>
                            <h4 class="mb-20">We help with the dedication & affection</h4>
                            <p class="mb-n2">We pay close attention to the grout lines, cleaning and restoring them to their original color and condition, giving the entire surface a refreshed look.</p>
                ...
                <div class="col-xxl-4 col-lg-4">
                    <aside class="sidebar-area">
                        ...
                        <div class="widget widget_download">
                            ...
                            <div class="download-widget-wrap"><a href="service-details.php" class="th-btn rounded-10"><i class="fa-light fa-file-pdf me-2"></i>DOWNLOAD PDF</a> <a href="service-details.php" class="th-btn style4 rounded-10"><i class="fa-light fa-file-lines me-2"></i>DOWNLOAD DOC</a></div>
                        </div>
                        <div class="widget widget_quote">
                            <h3 class="widget_title">Get A Quote</h3>
                            <form action="https://themeholy.com/php/frutin/demo/mail.php" method="POST" class="widget-form form-rounded-10">
                                ...
                                <div class="form-group"><input type="tel" class="form-control" name="number" id="number" placeholder="Your Number"> <i class="fal fa-phone"></i></div>
                                ...
                                <div class="form-btn"><button class="th-btn w-100">Ask Question Now</button></div>
