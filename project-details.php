...
<!-- Mirrored from themeholy.com/php/frutin/demo/project-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Nov 2023 13:49:17 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Frutin - Organic and Healthy Food php Template - Project Details</title>
    ...
    <section class="space overflow-hidden">
        <div class="container">
            <div class="project-details">
                ...
                <div class="page-img"><img src="assets/img/gallery/project_details.jpg" alt="Project Image"></div>
                ...
                <div class="project-nav"><a href="project-details.php" class="nav-btn"><i class="far fa-arrow-left icon-btn"></i> Previous </a><a href="project-details.php" class="nav-btn">Next <i class="far fa-arrow-right icon-btn"></i></a></div>
            </div>
        </div>
    </section>
    <div class="">
...
<!-- Mirrored from themeholy.com/php/frutin/demo/project-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Nov 2023 13:49:18 GMT -->
